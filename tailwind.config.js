  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        'dark-float': '0 4px 6px -1px rgba(0, 0, 0, 0.3), 0 2px 4px -1px rgba(0, 0, 0, 0.2)',
        'glow': '0 0 15px rgba(14, 165, 233, 0.3)',
        'dark-glow': '0 0 15px rgba(56, 189, 248, 0.4)',
      ...
      transitionProperty: {
        'dark-mode': 'background-color, border-color, color, fill, stroke',
      },
      transitionDuration: {
        'dark-mode': '300ms',
      },
      height: {
        'screen-navbar': 'calc(100vh - 64px)', // Adjust based on your navbar height
      },
      backdropFilter: {
        'none': 'none',
        'blur': 'blur(8px)',
